    ...
    <main className="min-h-screen bg-background text-foreground pt-20 pb-20">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="mb-12">
          <Link
            href="/"
            className="inline-flex items-center text-lg font-bold hover:underline decoration-4"
          >
        ...
        <div className="border-b-4 border-foreground pb-8 mb-12">
          <h1 className="text-4xl md:text-6xl lg:text-8xl font-black tracking-tighter uppercase leading-[0.8] mb-6 break-words">
            {project.title}
          </h1>
          <div className="flex flex-wrap gap-4 items-center justify-between">
            <div className="flex flex-wrap gap-2">
              {project.technologies.map((tech) => (
                <span
                  key={tech}
                  className="px-3 py-1 bg-foreground text-background font-bold text-sm uppercase tracking-widest border border-foreground"
                >
                  {tech}
                </span>
              ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="flex flex-col justify-center space-y-8">
            <div className="space-y-6">
              <h2 className="text-3xl font-black uppercase tracking-tighter decoration-4 underline decoration-foreground">
                The Brief
              </h2>
